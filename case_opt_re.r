...
#2020-OCT-20 copied and modified for Mouse_ to Human genes.


print("human genes_ < mouse using: genes_more ...")
genesmore <- readline()
...
more_genes <- sapply(strsplit(more_genes, ","), function(x){x[2]})
